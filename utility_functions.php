...
function add_javascript()
{
  global $post;
	...
	{
  	wp_enqueue_script( 'register_codes', get_template_directory_uri().'/assets/js/register-codes.js');
  	wp_localize_script( 'register_codes', 'ajax_url', admin_url('admin-ajax.php') );
	}
}
